...
export const createEmployee = (employee) =>
  axios.post(REST_API_BASE_URL, employee); // create employee

// export const getEmployee = (employeeId) =>
//   axios.get(REST_API_BASE_URL + "/" + employeeId); // get employee by id

export const getEmployee = (employeeId) =>
    axios.get(`${REST_API_BASE_URL}/id/${employeeId}`);
